...
plt.ylabel(r'$\widetilde{V}$',fontsize=16)
...
plt.fill_between(list(range(20))[int(reg_low3):int(reg_up3+1)], nsq3plt['EffectiveMass']+sigma3, nsq3plt['EffectiveMass']-sigma3, color='brown',alpha=0.2)
