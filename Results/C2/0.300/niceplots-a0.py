...
plt.errorbar(range(20), nsq1[0][:20], yerr=nsq1[1][:20], fmt='x', ls='none', color=colors[1], label='$n^2=1$')
plt.errorbar(range(20), nsq2[0][:20], yerr=nsq2[1][:20], fmt='x', ls='none', color=colors[2], label='$n^2=2$')
plt.errorbar(range(20), nsq3[0][:20], yerr=nsq3[1][:20], fmt='x', ls='none', color=colors[3], label='$n^2=3$')
plt.errorbar(range(20), nsq4[0][:20], yerr=nsq4[1][:20], fmt='x', ls='none', color=colors[4], label='$n^2=4$')
plt.errorbar(range(20), nsq5[0][:20], yerr=nsq5[1][:20], fmt='x', ls='none', color=colors[5], label='$n^2=5$')

# Dispersion Datenpunkte
plt.errorbar(range(20), nsq1_disp[0][:20], yerr=nsq1_disp[1][:20], fmt='x', ls='none', color=disp_colors[1], label='$n^2=1$ Disp')
plt.errorbar(range(20), nsq2_disp[0][:20], yerr=nsq2_disp[1][:20], fmt='x', ls='none', color=disp_colors[2], label='$n^2=2$ Disp')
plt.errorbar(range(20), nsq3_disp[0][:20], yerr=nsq3_disp[1][:20], fmt='x', ls='none', color=disp_colors[3], label='$n^2=3$ Disp')
plt.errorbar(range(20), nsq4_disp[0][:20], yerr=nsq4_disp[1][:20], fmt='x', ls='none', color=disp_colors[4], label='$n^2=4$ Disp')
plt.errorbar(range(20), nsq5_disp[0][:20], yerr=nsq5_disp[1][:20], fmt='x', ls='none', color=disp_colors[5], label='$n^2=5$ Disp')
