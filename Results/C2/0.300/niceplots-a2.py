...
#nsq0=pd.read_csv('Ratios/A2/A2-nsq0.txt', sep=' ', header=None)
nsq4=pd.read_csv('Ratios/A2/A2-nsq4.txt', sep=' ', header=None)
nsq5=pd.read_csv('Ratios/A2/A2-nsq5.txt', sep=' ', header=None)


nsq1plt=pd.read_csv('./Fits/A2/A2-Av-nsq1-Fit.csv',sep='\s')
nsq2plt=pd.read_csv('./Fits/A2/A2-Av-nsq2-Fit.csv',sep='\s')
#nsq0plt=pd.read_csv('./Fits/A2/A2-Av-nsq0-Fit.csv',sep='\s')
nsq4plt=pd.read_csv('./Fits/A2/A2-Av-nsq4-Fit.csv',sep='\s')
nsq5plt=pd.read_csv('./Fits/A2/A2-Av-nsq5-Fit.csv',sep='\s')
...
#plt.fill_between(list(range(47))[int(reg_low0):int(reg_up0+1)], nsq0plt['EffectiveMass']+sigmA1, nsq0plt['EffectiveMass']-sigmA1, color='g',alpha=0.2)
...
plt.fill_between(list(range(47))[int(reg_low2):int(reg_up2+1)], nsq2plt['EffectiveMass']+sigmA1, nsq2plt['EffectiveMass']-sigmA1, color='orange',alpha=0.2)
