...
plt.errorbar(list(range(29)), nsq1[0][1:30], yerr=nsq1[1][1:30],ls='none',fmt='x',label='$n^2=1$',color='b')
plt.errorbar(list(range(29)), nsq2[0][1:30], yerr=nsq2[1][1:30],ls='none',fmt='x',label='$n^2=2$',color='orange')
plt.errorbar(list(range(29)), nsq3[0][1:30], yerr=nsq3[1][1:30],ls='none',fmt='x',label='$n^2=3$',color='brown')
plt.errorbar(list(range(29)), nsq4[0][1:30], yerr=nsq4[1][1:30],ls='none',fmt='x',label='$n^2=4$',color='red')
plt.errorbar(list(range(29)), nsq5[0][1:30], yerr=nsq5[1][1:30],ls='none',fmt='x',label='$n^2=5$',color='magenta')
