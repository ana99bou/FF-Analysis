...
plt.errorbar(range(30), nsq1[0][:30], yerr=nsq1[1][:30], fmt='x', ls='none', color=colors[1], label='$n^2=1$')
plt.errorbar(range(30), nsq2[0][:30], yerr=nsq2[1][:30], fmt='x', ls='none', color=colors[2], label='$n^2=2$')
plt.errorbar(range(30), nsq3[0][:30], yerr=nsq3[1][:30], fmt='x', ls='none', color=colors[3], label='$n^2=3$')
plt.errorbar(range(30), nsq4[0][:30], yerr=nsq4[1][:30], fmt='x', ls='none', color=colors[4], label='$n^2=4$')
plt.errorbar(range(30), nsq5[0][:30], yerr=nsq5[1][:30], fmt='x', ls='none', color=colors[5], label='$n^2=5$')

# Dispersion Datenpunkte
plt.errorbar(range(30), nsq1_disp[0][:30], yerr=nsq1_disp[1][:30], fmt='x', ls='none', color=disp_colors[1], label='$n^2=1$ Disp')
plt.errorbar(range(30), nsq2_disp[0][:30], yerr=nsq2_disp[1][:30], fmt='x', ls='none', color=disp_colors[2], label='$n^2=2$ Disp')
plt.errorbar(range(30), nsq3_disp[0][:30], yerr=nsq3_disp[1][:30], fmt='x', ls='none', color=disp_colors[3], label='$n^2=3$ Disp')
plt.errorbar(range(30), nsq4_disp[0][:30], yerr=nsq4_disp[1][:30], fmt='x', ls='none', color=disp_colors[4], label='$n^2=4$ Disp')
plt.errorbar(range(30), nsq5_disp[0][:30], yerr=nsq5_disp[1][:30], fmt='x', ls='none', color=disp_colors[5], label='$n^2=5$ Disp')
...
for i, (c, plt_data, sigma, rlow, rup) in enumerate(zip(
    ...
    plt.plot([-1, 32], [em, em], color=c, linewidth=0.5)
...
plt.savefig('Niceplot-A0-Disp.pdf', transparent=True, dpi=300, bbox_inches='tight')
'''
...
plt.ylabel(r'$\widetilde{A}_0$',fontsize=16)
...
plt.savefig('Niceplot-A0-plain.pdf',transparent=True,dpi=300,bbox_inches='tight')
