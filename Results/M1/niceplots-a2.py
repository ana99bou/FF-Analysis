...
#nsq3=pd.read_csv('Ratios/A2/A2-nsq3.txt', sep=' ', header=None)
...
plt.fill_between(list(range(47))[int(reg_low2):int(reg_up2+1)], nsq2plt['EffectiveMass']+sigmV, nsq2plt['EffectiveMass']-sigmV, color='orange',alpha=0.2)
