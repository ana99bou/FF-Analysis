...
m2x_coords2 =[m2r2[1], m2r2[2], m2r2[3],m2r2[4],m2r2[5]]
...
v_coords_m2=[m21tmp1[0],m21tmp2[0],m21tmp3[0],m21tmp4[0],m21tmp5[0]]
v_errors_m2=[m21tmp1[1],m21tmp2[1],m21tmp3[1],m21tmp4[1],m21tmp5[1]]


v_coords_m22=[m22tmp1[0],m22tmp2[0],m22tmp3[0],m22tmp4[0],m22tmp5[0]]
v_errors_m22=[m22tmp1[1],m22tmp2[1],m22tmp3[1],m22tmp4[1],m22tmp5[1]]

print(md0c1*1.7848,md0m2*2.3833,md0m22*2.3833,md0f1s*2.785)
...
v_coords_m22 = [mrho_Vi*np.sqrt(M2Zacc2*M2ZVbb)*x for x in v_coords_m22]



plt.errorbar(c1x_coords, v_coords_c1, yerr=v_errors_c1, fmt='o', color='red',ecolor='red', capsize=5, capthick=2, elinewidth=1,label=r'C1, $am_c=0.400$')
plt.errorbar(m2x_coords2, v_coords_m22, yerr=v_errors_m22, fmt='o', color='cyan',ecolor='cyan', capsize=5, capthick=2, elinewidth=1,label=r'M2, $am_c=0.280$')
plt.errorbar(m2x_coords, v_coords_m2, yerr=v_errors_m2, fmt='o', color='blue',ecolor='blue', capsize=5, capthick=2, elinewidth=1,label=r'M2, $am_c=0.340$')
plt.errorbar(f1sx_coords, v_coords_f1s, yerr=v_errors_f1s, fmt='o', color='green',ecolor='green', capsize=5, capthick=2, elinewidth=1,label=r'F1S, $am_c=0.248$')
...
plt.legend()
plt.annotate(r'$\bf{preliminary}$',xy=(0.65,0.03),xycoords='axes fraction',fontsize=17,color='grey',alpha=1)
