...
# Messdaten
#nsq = {i: pd.read_csv(f'Ratios/V/V-nsq{i}-new.txt', sep=' ', header=None) for i in base_colors}
nsq = {i: pd.read_csv(f'Ratios/V/V-nsq{i}-Disp-new.txt', sep=' ', header=None) for i in disp_colors}
