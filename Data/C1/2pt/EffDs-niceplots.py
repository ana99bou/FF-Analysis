...
nsq2plt=pd.read_csv('Ds0.400Result-2.csv', sep='\s')
nsq3plt=pd.read_csv('Ds0.400Result-3.csv', sep='\s')
nsq3plt=pd.read_csv('Ds0.400Result-3.csv', sep='\s')
nsq4plt=pd.read_csv('Ds0.400Result-4.csv', sep='\s')
nsq5plt=pd.read_csv('Ds0.400Result-5.csv', sep='\s')
