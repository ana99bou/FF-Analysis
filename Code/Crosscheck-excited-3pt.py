...
v1=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 1][0]
v2=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m), comment="#", sep="\t").iloc[:, 1][1]
v3=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m), comment="#", sep="\t").iloc[:, 1][2]
v4=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m), comment="#", sep="\t").iloc[:, 1][3]
v5=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m), comment="#", sep="\t").iloc[:, 1][4]
...
v1e=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 2][0]
v2e=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 2][1]
v3e=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 2][2]
v4e=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 2][3]
v5e=pd.read_csv('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m),comment="#", sep="\t").iloc[:, 2][4]


error=[bs2ptem0,ds2pt0em0,ds2pt1em0,ds2pt2em0,ds2pt3em0,ds2pt4em0,ds2pt5em0,v1e,v2e,v3e,v4e,v5e]

v1p = None
with open('../Results/{}/{}/Fit/Excited-combined-V.csv'.format(ens,m)) as f:
    for line in f:
...
df3['Error']=error
df3['pval']=pval
df3.to_csv('../Results/Crosschecks/AB/Crosscheck-excited-{}-{}-3pt.csv'.format(ens,m), sep='\t')
