...
v1=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
v2=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
v3=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq3-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
v4=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
v5=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]

a01=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a02=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a03=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq3-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a04=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a05=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]

a10=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq0-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a11=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a12=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a14=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
a15=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['EffectiveMass'].iloc[0]
...
v1e=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
v2e=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
v3e=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq3-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
v4e=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
v5e=pd.read_csv('../Results/{}/{}/Fits/V/V-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]

a01e=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a02e=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a03e=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq3-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a04e=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a05e=pd.read_csv('../Results/{}/{}/Fits/A0/A0-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]

a10e=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq0-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a11e=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq1-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a12e=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq2-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a14e=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq4-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
a15e=pd.read_csv('../Results/{}/{}/Fits/A1/A1-Av-nsq5-Fit-Disp.csv'.format(ens,m), sep='\s')['Error'].iloc[0]
...
df3['Error']=error
df3['pval']=pval
df3.to_csv('../Results/Crosschecks/AB/Crosscheck-{}-{}-Disp.csv'.format(ens,m), sep='\t')
