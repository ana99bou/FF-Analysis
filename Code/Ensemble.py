...
def getEns(s):
    ...
    elif s=='M1': return 628,26,64,32
    elif s=='M2': return 889,26,64,32
    elif s=='M3': return 544,26,64,32
...
def getCmass(s):
    ...
    elif s=='C2': return ['0.300','0.350','0.400']
    elif s=='M1': return ['0.280','0.3203','0.340']
    elif s=='M2': return ['0.280','0.3203','0.340']
    elif s=='M3': return ['0.280','0.3203','0.340']

#Gives m,csw,zeta
def getRHQparams(s):
    if s=='M2':return [3.49,3.07,1.76]
    elif s=='M1':return [3.49,3.07,1.76]
